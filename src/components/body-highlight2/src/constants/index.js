import { ModelType } from "../component/metadata";

export const DEFAULT_MUSCLE_DATA = {
  trapezius: { exercises: [], frequency: 0 },
  traps: { exercises: [], frequency: 0 },
  ...
  abductor: { exercises: [], frequency: 0 },
...
export const DEFAULT_BODY_COLOR = "#DEADA7";
