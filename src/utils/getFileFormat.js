...
const FORMAT_IMG = ['jpg', 'jpeg', 'gif', 'bmp', 'png', 'heic', 'heif'];
const FORMAT_VIDEO = ['m4v', 'avi', 'mpg', 'mp4', 'webm', 'mov', 'hevc'];
...
export function getFileFormat(fileUrl) {
  if (fileUrl.type == 'youtube') {
    return 'video';
  }
  let format;
  fileUrl = typeof fileUrl === 'object' ? fileUrl.file : fileUrl;
