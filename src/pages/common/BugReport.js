...
export default function Contact() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setErrors, setSubmitting }) => {
            ...
            axios
                .post(api.protocol + api.baseUrl + api.reportBug, {
                    ...values,
                    email: Profile?.email,
                })
                .then((response) => {
                        ...
                        >
                            ...
                            >
                                <Typography
                                    ...
                                    component={'span'}
                                >
                                    Encountered an issue? Report it here! Be
                                    detailed and share steps, error messages, or
                                    relevant info. Attach pics or videos to
                                    explain better. Tap "Attach File" below.
                                ...
                                <Stack direction={'row'} spacing={2}>
                                    <Box width="70%">
                                        <LabeledInput
                                            fullWidth
                                            placeholder="Write your device model?"
                                            clabel="Device type"
