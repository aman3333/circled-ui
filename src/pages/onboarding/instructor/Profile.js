...
import { initProfile, updateProfile } from '../../../redux/actions/Profile'

export default function ProfilePic({ mode }) {
    const navigate = useNavigate()
    const { state } = useLocation()
    const Profile = useSelector((s) => s.Profile)
    const [profilePic, setPic] = useState(Profile.profilePic)
    ...
    useEffect(() => {
        dispatch(initProfile({ ...Profile, profilePic: profilePic }))
    }, [profilePic, about])
